...
- A token stored without any scope (issued before scopes were canonicalised) counts as the DCR default scope, `openid memory:read memory:write memory:delete offline_access`.
