...
- `.claude/commands/` — Slash commands (`/test`, `/quality`, `/self-review`, `/recall`, `/remember`, `/issue-start`, `/self-maint`, `/api-docs-audit`, `/workflow`, `/release`, `/guide`, `/setup`, `/docker`, `/admin`)
