...
async def system_info():
    ...
    return {
        ...
        "features": {
            ...
            # Issue #1571: default-on. When false the web UI renders no money
            # (cost page + nav entry, analysis KPI / column / estimate) and the
            # workspace cost API 404s; /admin/cost stays for system admins.
            "cost_display": settings.enable_cost_display,
