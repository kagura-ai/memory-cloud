...
class Settings(BaseSettings):
    ...
    enable_byok: bool = Field(
        ...
        description=(
            ...
            "key-status probe return 404; the web UI hides the cost dashboard's nav "
            "entry, and the External Keys entry stays only for a workspace that "
            "already stores a key (#1616). "
            "v0.42 review #32: key MANAGEMENT (list / toggle / delete) stays "
