    ...
    async for db in get_db():
        try:
            ...
            return _tool_exception_response(
                "secret_register_pubkey", e, error="secret_register_pubkey_error"
            )
...
async def handle_secret_put(
    ...
    async for db in get_db():
        try:
            ...
            return _tool_exception_response("secret_put", e, error="secret_put_error")
    return _error_response("internal_error", "Failed to acquire database session")
...
async def handle_secret_get(
    ...
    async for db in get_db():
        try:
            ...
            return _tool_exception_response("secret_get", e, error="secret_get_error")
    return _error_response("internal_error", "Failed to acquire database session")
...
async def handle_secret_list(
    ...
    async for db in get_db():
        try:
            ...
            return _tool_exception_response("secret_list", e, error="secret_list_error")
    return _error_response("internal_error", "Failed to acquire database session")
...
async def handle_secret_revoke_grant(
    ...
    async for db in get_db():
        try:
            ...
            return _tool_exception_response(
                "secret_revoke_grant", e, error="secret_revoke_grant_error"
            )
    return _error_response("internal_error", "Failed to acquire database session")
